...
extern MY_HIGHP_OR_MEDIUMP vec2 pocketedition;
...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    float POLY_THROWAWAY = (.5 + .5* cos( (pocketedition.x) * 2.612 + ( 0.2 + -.5 ) *3.14));
    float POLY_THROWAWAY_2 = POLY_THROWAWAY + pocketedition.y * 0.04;
