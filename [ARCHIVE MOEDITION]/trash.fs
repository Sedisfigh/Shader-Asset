...
extern MY_HIGHP_OR_MEDIUMP vec2 trash;
...
vec4 effect( vec4 colour, Image texture, vec2 texture_coords, vec2 screen_coords )
{
    ...
    float POLY_THROWAWAY = (.5 + .5* cos( (trash.x) * 2.612 + ( 0.2 + -.5 ) *3.14));
    float POLY_THROWAWAY_2 = POLY_THROWAWAY + trash.y * 0.04;
    ...
    texCoordsR.x += (0.000 * rand(vec2(iTime, texCoordsR.y))) - 0.000 + (POLY_THROWAWAY * 0.0000001);
    texCoordsG.x += (0.000 * rand(vec2(iTime*2, texCoordsG.y*0.9))) - 0.000 + (POLY_THROWAWAY * 0.0000001);
    texCoordsB.x += (0.2 * rand(vec2(iTime*3, texCoordsB.y*0.8))) - 0.000 + (POLY_THROWAWAY_2 * 0.0000001);
